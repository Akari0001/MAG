    ...
    try {
      ...
      message.channel.send(
        new MessageEmbed()
          ...
          .setDescription(`Showing information for <@${member.user.id}> (\`${member.user.id}\`)`)
          .addField(`Total Messages Send`, `**${Database.messages}**`, true)
          .addField(`Leaderboard Position`, `**${Position + 1 || "This user isnt on the leaderboard"}**`, true)
